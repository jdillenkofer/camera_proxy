...
class BaichuanUdpLayer:
    ...
    def _send_discovery_broadcast(self):
        ...
        server_address = ('', self.discovery_src_port)
        ...
        tid = 3290
        enc_xml_bytes = self.de_or_encrypt_udp_message(xml_bytes, tid)
        ...
        discovery_message += tid.to_bytes(4, 'little')
